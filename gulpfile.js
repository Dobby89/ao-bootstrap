...
const PROJECT_NAME = 'ao-bootstrap'; // Change project name to your project name
const PROJECT_SERVER_PATH = '//media.ao.com/uk/qa/ao-bootstrap/'; // Change project server path to your project path
